...
Cubo::Cubo(GLdouble a,GLdouble l,GLdouble g,ColorRGB* c,TAfin* t,unsigned int *tx,int nt)
:Malla(8,6,6,new PV3D*[8],new PV3D*[6],new Cara*[6],c,t,tx,nt){
...
void Cubo::trasladar(GLdouble x, GLdouble y, GLdouble z){
        m->trasladar(x,y,z);
}

void Cubo::girar(GLdouble alfa, GLdouble x, GLdouble y, GLdouble z){
        m->girar(alfa,x,y,z);
}

void Cubo::escalar(GLdouble x, GLdouble y, GLdouble z){
        m->escalar(x,y,z);
}
