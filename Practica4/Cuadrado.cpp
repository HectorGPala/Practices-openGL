...
Cuadrado::Cuadrado(PVD2 *centro,GLdouble l){
        ...
        normal[0] = new PVD2(coordenada[1]->getY()-coordenada[0]->getY(),-coordenada[1]->getX()-coordenada[0]->getX());
        normal[1] = new PVD2(coordenada[2]->getY()-coordenada[1]->getY(),-coordenada[2]->getX()-coordenada[1]->getX());
        normal[2] = new PVD2(coordenada[3]->getY()-coordenada[2]->getY(),-coordenada[3]->getX()-coordenada[2]->getX());
        normal[3] = new PVD2(coordenada[0]->getY()-coordenada[3]->getY(),-coordenada[0]->getX()-coordenada[3]->getX());
        rojo = verde = azul = 0.0f;
        selec = false;
}
